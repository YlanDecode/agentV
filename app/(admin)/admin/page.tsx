...
import { BarChart3Icon, BookOpenIcon, BotIcon, MicIcon, UsersIcon } from "lucide-react";
...
export default function AdminPage() {
  const sections = [
    ...
    },
    {
      ...
      title: "Analytics & KPI",
      description: "Surveillez sessions, qualité, quotas et alertes opérationnelles en un coup d’œil.",
      icon: BarChart3Icon,
    },
  ];
          ...
          <div className="max-w-2xl space-y-3">
            ...
            <div>
              <h1 className="text-2xl font-semibold tracking-tight text-foreground md:text-3xl">
                Un cockpit plus clair, en 4 zones.
              </h1>
              <p className="mt-2 text-sm leading-6 text-muted-foreground md:text-base">
                L&apos;ancien empilement de menus a été remplacé par un parcours simple : régler
                l&apos;assistant, maintenir le corpus, piloter les voix, puis suivre les KPI.
              </p>
            </div>
          </div>

          <div className="grid gap-3 rounded-2xl border border-border bg-background/70 p-4 text-sm text-muted-foreground md:grid-cols-4">
            <div>
            ...
            <div>
              <p className="font-medium text-foreground">4. KPI</p>
              <p className="mt-1">Vue analytique en direct.</p>
            </div>
          </div>
        </div>
      </section>
